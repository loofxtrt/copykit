...
def switch(target_dir: Path, source_dir: Path):
    """
        ...
        por segurança, não faz substitue recursivamente, e só afeta os itens especificamente do dir indicado  
        mas a busca em si pra achar os substitutos é recursiva
    """
    ...
    source_dir = {f.name: f for f in source_dir.rglob("*") if f.is_file()}
